    ...
    return (
        <div className="App">
            ...
            <header className="App-header">
                ...
                {AuthClient.ACCESS_TOKEN==null ? (<Link to="/register"><button type="menu-button">Sign Up</button></Link>) : null}
                {AuthClient.ACCESS_TOKEN!=null ? (<Link to="/profile"><button type="menu-button">Profile</button></Link>) : null}
